...
const s_savedata savedata_default = {
	...
	.keys[0][SDID_ATTACK] = JPF_BUTTON_RED,
	.keys[0][SDID_ATTACK2] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[0][SDID_ATTACK3] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[0][SDID_ATTACK4] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[0][SDID_JUMP] = JPF_BUTTON_BLUE,
	.keys[0][SDID_SPECIAL] = 0x400,
	.keys[0][SDID_START] = 0x4000,
	.keys[0][SDID_SCREENSHOT] = CONTROL_DEFAULT1_SCREENSHOT,
	.keys[1][SDID_MOVEUP] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_MOVEDOWN] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_MOVELEFT] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_MOVERIGHT] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_ATTACK] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_ATTACK2] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_ATTACK3] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_ATTACK4] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_JUMP] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_SPECIAL] = CONTROL_DEFAULT2_SCREENSHOT,
	.keys[1][SDID_START] = CONTROL_DEFAULT2_SCREENSHOT,
